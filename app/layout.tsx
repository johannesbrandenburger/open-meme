      ...
      <html lang="en">
        <body className="min-h-screen bg-background text-foreground font-sans antialiased">
          ...
          <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
            {/* Color blobs */}
            <div className="absolute -top-24 -left-24 h-[50vh] w-[60vw] rounded-full bg-[radial-gradient(circle_at_30%_30%,color-mix(in_oklab,var(--color-primary)_55%,transparent),transparent_60%)] blur-3xl opacity-80" />
            <div className="absolute -top-16 right-0 h-[40vh] w-[45vw] rounded-full bg-[radial-gradient(circle_at_70%_30%,color-mix(in_oklab,var(--color-accent)_50%,transparent),transparent_60%)] blur-3xl opacity-70" />
